 ...
 */
// 指定处理器支持的注解类型：
@SupportedAnnotationTypes("com.corejava.chapter10_6.Property")
@SupportedSourceVersion(SourceVersion.RELEASE_8)
// 自定义注解处理器
public class BeanInfoAnnotationProcessor extends AbstractProcessor
{
	// process 方法有两个参数：
	// annotations 一个是在本轮中要进行处理的注解集，另一个是包含了有关当前处理轮次的信息的RoundEnv 引用；
   @Override
      ...
      throws IOException
   {
      ...
      // 编写源文件的代码简单明了，仅仅是一系列的 out.println 语句
      if (i > 0)
      {
         out.print("package ");
